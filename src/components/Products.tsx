  ...
  const products = [
    {
      ...
      title: "Toys",
      description:
        "Fun, safe, and durable 3D printed toys. Perfect for gifts and collectors.",
    },
    {
      icon: "🏺",
      title: "Vases",
      description:
        "Modern decorative vases in unique geometric designs for any space.",
    },
    {
      icon: "🪑",
      title: "Furniture",
      description:
        "Modular furniture pieces and accessories. Functional and stylish.",
    },
  ];
